-- =============================================================================
-- Migration 001: Initial Schema (ساختار اولیه پایگاه داده خطی‌نو)
-- دامنه: khatynoo.ir
-- همه جداول و اندیس‌ها به صورت IF NOT EXISTS ساخته می‌شوند (Idempotent)
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS unit_definitions (
    ...
    conversion_factor NUMERIC(12, 3) NOT NULL DEFAULT 1.0,
    description TEXT,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS products (
    ...
    price_shop1 BIGINT NOT NULL DEFAULT 0,
    price_shop2 BIGINT NOT NULL DEFAULT 0,
    price_shop3 BIGINT NOT NULL DEFAULT 0,
    wholesale_price BIGINT NOT NULL DEFAULT 0,
    min_allowed_price BIGINT NOT NULL DEFAULT 0,
    stock NUMERIC(14, 3) NOT NULL DEFAULT 0,
    min_stock_alert NUMERIC(14, 3) NOT NULL DEFAULT 5,
    description TEXT,
    image_url TEXT,
...
CREATE TABLE IF NOT EXISTS suppliers (
    ...
    mobile VARCHAR(30) NOT NULL,
    address TEXT,
    debt_to_supplier BIGINT DEFAULT 0,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
